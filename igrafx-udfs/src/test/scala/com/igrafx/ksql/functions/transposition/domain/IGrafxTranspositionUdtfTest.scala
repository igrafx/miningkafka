...
class IGrafxTranspositionUdtfTest extends UnitTestSpec {
  val igrafxTranspositionUdtf = new IGrafxTranspositionUdtf()
  ...
  describe("filteredSeq") {
    it(
      ...
      assert(Seq.empty == igrafxTranspositionUdtf.filteredSeq(Seq.empty))

      val seqTest1 = Seq(structVide, structNull)
      assert(Seq.empty == igrafxTranspositionUdtf.filteredSeq(seqTest1))
    }
    it("should return a Seq without the elements having a TIME field empty or null") {
      ...
      assert(seqTest1 == igrafxTranspositionUdtf.filteredSeq(seqTest1))

      val seqTest2 = Seq(struct1, structVide, struct3, structNull, struct5)
      val seqTest2Expected = Seq(struct1, struct3, struct5)
      assert(seqTest2Expected == igrafxTranspositionUdtf.filteredSeq(seqTest2))
    }
  }

  describe("igrafxTransposition") {
    it(
      ...
      assert(emptyList == igrafxTranspositionUdtf.igrafxTransposition(emptyList))
      assert(
        emptyList == igrafxTranspositionUdtf.igrafxTransposition(
          emptyList,
          "dd/MM/yyyy",
      ...
      assert(emptyList == igrafxTranspositionUdtf.igrafxTransposition(listTest))
      assert(
        emptyList == igrafxTranspositionUdtf.igrafxTransposition(
          emptyList,
          "dd/MM/yyyy",
    ...
    it(
      ...
      assert(listTest1 == igrafxTranspositionUdtf.igrafxTransposition(listTest1))
      ...
      assert(listTest2Expected == igrafxTranspositionUdtf.igrafxTransposition(listTest2))
    }
    ...
    it("should return a Java List with good values when isStartInformation and isTaskNameAscending are both true") {
      ...
      assert(
        listTestExpected == igrafxTranspositionUdtf.igrafxTransposition(
          listTest,
          "dd/MM/yyyy",
          isStartInformation = true,
          isTaskNameAscending = true
