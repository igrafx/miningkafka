...
import com.igrafx.ksql.functions.prediction.adapters.api.dtos.{
  CasePredictionDto,
...
class IGrafxPredictionUdfTest extends UnitTestSpec {
  val igrafxPredictionUdf = new IGrafxPredictionUdf
  ...
  describe("generatePredictionConfidenceIntervalStruct") {
    it("should create a Struct from a PredictionConfidenceIntervalDto correctly") {
      assert(
        igrafxPredictionUdf.generatePredictionConfidenceIntervalStruct(
  ...
  describe("generatePredictionStepStruct") {
    it("should create a Struct from a PredictionStepDto correctly") {
      assert(igrafxPredictionUdf.generatePredictionStepStruct(predictionStep1) == predictionStep1Struct)
      assert(igrafxPredictionUdf.generatePredictionStepStruct(predictionStep2) == predictionStep2Struct)
      assert(igrafxPredictionUdf.generatePredictionStepStruct(predictionStep3) == predictionStep3Struct)
      assert(igrafxPredictionUdf.generatePredictionStepStruct(predictionStep4) == predictionStep4Struct)
    }
  }
  ...
  describe("generatePredictionsStruct") {
    it("should create a correct Iterable[Struct] from a Iterable[PredictionDto]") {
      assert(igrafxPredictionUdf.generatePredictionsStruct(predictionIterable) == predictionResultList)
    }
  }
  ...
  describe("generateFinalProcessKeyPredictionsStruct") {
    it("should create a correct Iterable[Struct] from a Iterable[FinalProcessKeyPredictionDto]") {
      assert(
        igrafxPredictionUdf.generateFinalProcessKeyPredictionsStruct(
  ...
  describe("generateCasePredictionStruct") {
    it("should create a correct Iterable[Struct] from a Iterable[CasePredictionDto]") {
      assert(igrafxPredictionUdf.generateCasePredictionStruct(casePredictionIterable) == casePredictionResultList)
    }
  }
  ...
  describe("generatePredictionResponseStruct") {
    it("should create a Struct from a PredictionResponseDto correctly") {
      assert(igrafxPredictionUdf.generatePredictionResponseStruct(predictionResponse) == predictionResponseStruct)
    }
  }
}
